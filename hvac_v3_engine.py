    ...
    for step in range(cfg.years * steps_per_year):
        ...
        row = {
            ...
            **tf,
            ...
            "cooling_hvac_kwh_period": thermal_terms.get("P_cooling_hvac", 0.0) * duration_hours,
            "heating_hvac_kwh_period": thermal_terms.get("P_heating_hvac", 0.0) * duration_hours,
